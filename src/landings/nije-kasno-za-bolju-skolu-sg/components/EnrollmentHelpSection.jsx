...
export function EnrollmentHelpSection() {
  ...
  return (
    <section className="nije-kasno-za-bolju-skolu-sg-landing-section nije-kasno-za-bolju-skolu-sg-enrollment-help">
      <div className="nije-kasno-za-bolju-skolu-sg-landing-container nije-kasno-za-bolju-skolu-sg-enrollment-help__inner">
        <div className="nije-kasno-za-bolju-skolu-sg-enrollment-help__intro">
          <div className="nije-kasno-za-bolju-skolu-sg-enrollment-help__content">
            ...
            <p className="nije-kasno-za-bolju-skolu-sg-enrollment-help__contacts">
              <a href="tel:+381114011223">{enrollmentHelp.phonePrimary}</a>;{' '}
              <a href="tel:+381621918056">{enrollmentHelp.phoneSecondary}</a>, pišite na{' '}
              <a className="nije-kasno-za-bolju-skolu-sg-enrollment-help__messenger-link" href="viber://chat?number=%2B381621918056">
                <ViberIcon />
                <span>{enrollmentHelp.viberLabel}</span>
              </a>{' '}
              i{' '}
              <a className="nije-kasno-za-bolju-skolu-sg-enrollment-help__messenger-link" href="https://wa.me/381621918056">
                <WhatsAppIcon />
          ...
          <div className="nije-kasno-za-bolju-skolu-sg-enrollment-help__advisor" aria-label="Savetnica za upis Katarina Petrovic">
            <div className="nije-kasno-za-bolju-skolu-sg-enrollment-help__advisor-photo">
        ...
        <LeadForm className="nije-kasno-za-bolju-skolu-sg-lead-form--enrollment" />
      </div>
    </section>
  )
}
