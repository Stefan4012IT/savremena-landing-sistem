...
function AnimatedStat({ stat, shouldAnimate }) {
  ...
  return (
    <article className="nije-kasno-za-bolju-skolu-sg-stats-section__item">
      <p className="nije-kasno-za-bolju-skolu-sg-stats-section__value">
        {stat.prefix}
        {displayValue}
        {stat.suffix}
      </p>
      <p className="nije-kasno-za-bolju-skolu-sg-stats-section__label">{stat.label}</p>
    </article>
  )
}
...
export function StatsSection() {
  ...
  return (
    <section className="nije-kasno-za-bolju-skolu-sg-landing-section nije-kasno-za-bolju-skolu-sg-stats-section" ref={sectionRef}>
      <div className="nije-kasno-za-bolju-skolu-sg-landing-container nije-kasno-za-bolju-skolu-sg-stats-section__grid">
        {stats.map((stat) => (
