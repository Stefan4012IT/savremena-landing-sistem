...
export function BenefitsSection() {
  ...
  return (
    <section className="nije-kasno-za-bolju-skolu-sg-landing-section nije-kasno-za-bolju-skolu-sg-benefits-section">
      <div className="nije-kasno-za-bolju-skolu-sg-landing-container">
        <SectionHeader
          ...
          text={section.text}
        />
        <div className="nije-kasno-za-bolju-skolu-sg-benefits-grid">
          {benefitCards.map((benefit) => {
            ...
            return (
            <article className="nije-kasno-za-bolju-skolu-sg-benefit-card" key={title}>
              <div className="nije-kasno-za-bolju-skolu-sg-benefit-card__image" aria-hidden="true">
