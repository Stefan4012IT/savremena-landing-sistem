...
export function FutureSpaceSection() {
  return (
    <section className="nije-kasno-za-bolju-skolu-sg-landing-section nije-kasno-za-bolju-skolu-sg-future-space">
      <div className="nije-kasno-za-bolju-skolu-sg-landing-container">
        ...
        <div className="nije-kasno-za-bolju-skolu-sg-future-space__carousel" aria-label="Prostor Savremene gimnazije">
          <div className="nije-kasno-za-bolju-skolu-sg-future-space__track">
            {carouselImages.map((imageUrl, index) => (
              <figure className="nije-kasno-za-bolju-skolu-sg-future-space__slide" key={`${imageUrl}-${index}`}>
