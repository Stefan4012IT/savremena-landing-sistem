...
export function PartnerLogosSection() {
  return (
    <section className="nije-kasno-za-bolju-skolu-sg-partner-logos" aria-label="Svetske nagrade">
      <div className="nije-kasno-za-bolju-skolu-sg-landing-container nije-kasno-za-bolju-skolu-sg-partner-logos__grid">
        <SectionHeader
        ...
        <div className="nije-kasno-za-bolju-skolu-sg-partner-logos__row">
          {awardLogos.map((logo) => (
            <div className="nije-kasno-za-bolju-skolu-sg-partner-logos__item" key={logo.src}>
