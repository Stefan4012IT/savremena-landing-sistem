export const landingData = {
  ...
  benefitCards: [
    { title: 'Kreativni i zanimljivi časovi', imageUrl: '' },
    { title: 'Najsavremenija tehnologija u nastavi', imageUrl: '' },
    { title: 'Dvojezično obrazovanje', imageUrl: '' },
    { title: 'Jedinstveni nastavni program', imageUrl: '' },
    { title: 'Future Ready School', imageUrl: '' },
    { title: 'Razvoj višestruke inteligencije', imageUrl: '' },
    { title: 'Zdravo, sigurno i podsticajno okruženje', imageUrl: '' },
    { title: 'Priznate međunarodne diplome', imageUrl: '' },
    { title: 'Otvorena vrata za nastavak školovanja', imageUrl: '' },
    { title: 'Life Skills program životnih veština', imageUrl: '' },
  ],
  testimonials: {
