...
export function EnrollmentHelpSection() {
  ...
  return (
    <section className="malo-mesta-enrollment-help">
      <div className="malo-mesta-enrollment-help__inner">
        <div className="malo-mesta-enrollment-help__intro">
          <div className="malo-mesta-enrollment-help__content">
            <h2>{enrollmentHelp.title}</h2>
            <p>
              {enrollmentHelp.introBeforeName} <strong>{enrollmentHelp.advisorName}</strong>, {enrollmentHelp.introAfterName}
            </p>
            <p><strong>{enrollmentHelp.emphasis}</strong></p>
            <p>{enrollmentHelp.prompt}</p>
            <p className="malo-mesta-enrollment-help__contacts">
              <a href="tel:+381114011223">{enrollmentHelp.phonePrimary}</a>;{' '}
              <a href="tel:+381621918056">{enrollmentHelp.phoneSecondary}</a>, pišite na{' '}
              <a className="malo-mesta-enrollment-help__messenger-link" href="viber://chat?number=%2B381621918056">
                <ViberIcon />
                <span>Viber</span>
              </a>{' '}
              i{' '}
              <a className="malo-mesta-enrollment-help__messenger-link" href="https://wa.me/381621918056">
                <WhatsAppIcon />
                <span>WhatsApp</span>
              </a>{' '}
          ...
          <div className="malo-mesta-enrollment-help__advisor" aria-label="Savetnica za upis">
