...
function AnimatedStat({ stat, shouldAnimate }) {
  ...
  return (
    <article className="malo-mesta-stats__item">
      <p className="malo-mesta-stats__value">
        {stat.prefix}
        {displayValue}
        {stat.suffix}
      </p>
      <p className="malo-mesta-stats__label">{stat.label}</p>
    </article>
  )
}
...
export function StatsSection() {
  ...
  return (
    <section className="malo-mesta-stats" ref={sectionRef}>
      <div className="malo-mesta-stats__grid">
        {stats.map((stat) => <AnimatedStat stat={stat} shouldAnimate={shouldAnimate} key={stat.label} />)}
      </div>
    </section>
  )
}
