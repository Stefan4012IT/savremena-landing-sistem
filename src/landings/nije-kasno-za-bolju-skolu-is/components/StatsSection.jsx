...
function AnimatedStat({ stat, shouldAnimate }) {
  ...
  return (
    <article className="nije-kasno-za-bolju-skolu-is-stats-section__item">
      <p className="nije-kasno-za-bolju-skolu-is-stats-section__value">
        {stat.prefix}
        {displayValue}
        {stat.suffix}
      </p>
      <p className="nije-kasno-za-bolju-skolu-is-stats-section__label">{stat.label}</p>
    </article>
  )
}
