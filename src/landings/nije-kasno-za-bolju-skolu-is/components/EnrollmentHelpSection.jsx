...
export function EnrollmentHelpSection() {
  ...
  return (
    <section className="nije-kasno-za-bolju-skolu-is-landing-section nije-kasno-za-bolju-skolu-is-enrollment-help">
      <div className="nije-kasno-za-bolju-skolu-is-landing-container nije-kasno-za-bolju-skolu-is-enrollment-help__inner">
        <div className="nije-kasno-za-bolju-skolu-is-enrollment-help__intro">
          <div className="nije-kasno-za-bolju-skolu-is-enrollment-help__content">
        ...
        <LeadForm className="nije-kasno-za-bolju-skolu-is-lead-form--enrollment" />
      </div>
    </section>
  )
}
