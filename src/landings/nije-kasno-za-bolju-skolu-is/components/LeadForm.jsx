...
export function LeadForm({ className = '', headerTitle, headerText }) {
  ...
  return (
    <>
      <form className={`nije-kasno-za-bolju-skolu-is-lead-form${className ? ` ${className}` : ''}`} onSubmit={handleSubmit} noValidate>
        {headerTitle || headerText ? (
          <div className="nije-kasno-za-bolju-skolu-is-lead-form__header">
        ...
        <input
          className="nije-kasno-za-bolju-skolu-is-lead-form__honeypot"
          type="text"
          name="website"
          tabIndex="-1"
          autoComplete="off"
          aria-hidden="true"
        />
        <div className="nije-kasno-za-bolju-skolu-is-lead-form__row">
        ...
        <div className="nije-kasno-za-bolju-skolu-is-lead-form__row nije-kasno-za-bolju-skolu-is-lead-form__row--phone">
        ...
        {status === 'error' ? (
          <p className="nije-kasno-za-bolju-skolu-is-lead-form__message" role="alert">
            {message}
          </p>
        ) : null}
      ...
      {status === 'success' ? (
        <div className="nije-kasno-za-bolju-skolu-is-lead-form-modal" role="dialog" aria-modal="true" aria-labelledby="nije-kasno-za-bolju-skolu-is-lead-form-success-title">
          <div className="nije-kasno-za-bolju-skolu-is-lead-form-modal__panel">
            <h3 id="nije-kasno-za-bolju-skolu-is-lead-form-success-title">{leadForm.successTitle || 'Prijava je poslata'}</h3>
            <p>
