...
export function TestimonialCard({
  ...
  return (
    <article className={`nije-kasno-za-bolju-skolu-is-testimonial-card nije-kasno-za-bolju-skolu-is-testimonial-card--${variant}`}>
        ...
        {isVideo ? (
          <div className="nije-kasno-za-bolju-skolu-is-testimonial-card__video" aria-label={`Video testimonijal: ${title}`}>
            {isPlaying && autoplayUrl ? (
              ...
              <>
                {videoImageUrl ? (
                  <img className="nije-kasno-za-bolju-skolu-is-testimonial-card__video-image" src={videoImageUrl} alt="" />
                ) : (
                  <span className="nije-kasno-za-bolju-skolu-is-testimonial-card__video-person">{author}</span>
                )}
                <button
      ...
      <footer className="nije-kasno-za-bolju-skolu-is-testimonial-card__footer">
        {!isVideo ? (
          <div className="nije-kasno-za-bolju-skolu-is-testimonial-card__avatar" aria-hidden="true">
