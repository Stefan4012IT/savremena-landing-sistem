...
export function EnrollmentHelpSection() {
  ...
  return (
    <section className="deset-slobodnih-mesta-landing-section deset-slobodnih-mesta-enrollment-help">
      <div className="deset-slobodnih-mesta-landing-container deset-slobodnih-mesta-enrollment-help__inner">
        <div className="deset-slobodnih-mesta-enrollment-help__intro">
          <div className="deset-slobodnih-mesta-enrollment-help__content">
            ...
            <p className="deset-slobodnih-mesta-enrollment-help__contacts">
              <a href="tel:+381114011223">{enrollmentHelp.phonePrimary}</a>;{' '}
              <a href="tel:+381621918056">{enrollmentHelp.phoneSecondary}</a>, pišite na{' '}
              <a className="deset-slobodnih-mesta-enrollment-help__messenger-link" href="viber://chat?number=%2B381621918056">
                <ViberIcon />
                <span>{enrollmentHelp.viberLabel}</span>
              </a>{' '}
              i{' '}
              <a className="deset-slobodnih-mesta-enrollment-help__messenger-link" href="https://wa.me/381621918056">
                <WhatsAppIcon />
          ...
          <div className="deset-slobodnih-mesta-enrollment-help__advisor" aria-label="Savetnica za upis Katarina Petrovic">
            <div className="deset-slobodnih-mesta-enrollment-help__advisor-photo">
