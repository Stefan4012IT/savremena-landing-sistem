...
export function LeadForm({ className = '', headerTitle, headerText }) {
  ...
  const landingSlug = slug || '10-slobodnih-mesta'
  ...
  return (
    <>
      <form className={`deset-slobodnih-mesta-lead-form${className ? ` ${className}` : ''}`} onSubmit={handleSubmit} noValidate>
        {headerTitle || headerText ? (
          <div className="deset-slobodnih-mesta-lead-form__header">
        ...
        <input
          className="deset-slobodnih-mesta-lead-form__honeypot"
          type="text"
          name="website"
          tabIndex="-1"
          autoComplete="off"
          aria-hidden="true"
        />
        <div className="deset-slobodnih-mesta-lead-form__row">
        ...
        <div className="deset-slobodnih-mesta-lead-form__row deset-slobodnih-mesta-lead-form__row--phone">
        ...
        {status === 'error' ? (
          <p className="deset-slobodnih-mesta-lead-form__message" role="alert">
            {message}
          </p>
        ) : null}
      ...
      {status === 'success' ? (
        <div className="deset-slobodnih-mesta-lead-form-modal" role="dialog" aria-modal="true" aria-labelledby="deset-slobodnih-mesta-lead-form-success-title">
          <div className="deset-slobodnih-mesta-lead-form-modal__panel">
            <h3 id="deset-slobodnih-mesta-lead-form-success-title">{leadForm.successTitle || 'Prijava je poslata'}</h3>
            <p>
