...
export function PartnerLogosSection() {
  return (
    <section className="deset-slobodnih-mesta-partner-logos" aria-label="Svetske nagrade">
      <div className="deset-slobodnih-mesta-landing-container deset-slobodnih-mesta-partner-logos__grid">
        <SectionHeader
        ...
        />
        <div className="deset-slobodnih-mesta-partner-logos__row">
          {awardLogos.map((logo) => (
            <div className="deset-slobodnih-mesta-partner-logos__item" key={logo.src}>
