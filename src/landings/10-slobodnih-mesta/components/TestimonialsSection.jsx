...
export function TestimonialsSection() {
  ...
  return (
    <section className="deset-slobodnih-mesta-landing-section deset-slobodnih-mesta-testimonials-section">
      <div className="deset-slobodnih-mesta-landing-container">
        <SectionHeader
          ...
          text={section.text}
        />
        <div className="deset-slobodnih-mesta-testimonials-carousel" aria-label="Testimonijali">
          <div className="deset-slobodnih-mesta-testimonials-carousel__track" ref={trackRef}>
            {testimonialCards.map((testimonial, index) => {
              ...
              return (
                <div
                  className="deset-slobodnih-mesta-testimonials-carousel__slide"
          ...
          <div className="deset-slobodnih-mesta-testimonials-carousel__dots" aria-label="Navigacija testimonijala">
            {testimonialCards.map((testimonial, index) => (
              <button
                className={index === activeIndex ? 'deset-slobodnih-mesta-is-active' : ''}
                type="button"
                key={testimonial.title}
