...
export function EnrollmentHelpSection() {
  ...
  return (
    <section className="nije-kasno-za-bolju-skolu-sos-landing-section nije-kasno-za-bolju-skolu-sos-enrollment-help">
      <div className="nije-kasno-za-bolju-skolu-sos-landing-container nije-kasno-za-bolju-skolu-sos-enrollment-help__inner">
        <div className="nije-kasno-za-bolju-skolu-sos-enrollment-help__intro">
          <div className="nije-kasno-za-bolju-skolu-sos-enrollment-help__content">
            ...
            <p className="nije-kasno-za-bolju-skolu-sos-enrollment-help__contacts">
              ...
              i{' '}
              <a className="nije-kasno-za-bolju-skolu-sos-enrollment-help__messenger-link" href="https://wa.me/381621918056">
                <WhatsAppIcon />
          ...
          <div className="nije-kasno-za-bolju-skolu-sos-enrollment-help__advisor" aria-label="Savetnica za upis Katarina Petrovic">
            <div className="nije-kasno-za-bolju-skolu-sos-enrollment-help__advisor-photo">
        ...
        <LeadForm className="nije-kasno-za-bolju-skolu-sos-lead-form--enrollment" />
      </div>
    </section>
  )
}
