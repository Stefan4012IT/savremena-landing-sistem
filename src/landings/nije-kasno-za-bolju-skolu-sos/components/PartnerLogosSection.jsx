...
export function PartnerLogosSection() {
  return (
    <section className="nije-kasno-za-bolju-skolu-sos-partner-logos" aria-label="Svetske nagrade">
      <div className="nije-kasno-za-bolju-skolu-sos-landing-container nije-kasno-za-bolju-skolu-sos-partner-logos__grid">
        <SectionHeader
        ...
        />
        <div className="nije-kasno-za-bolju-skolu-sos-partner-logos__row">
          {awardLogos.map((logo) => (
            <div className="nije-kasno-za-bolju-skolu-sos-partner-logos__item" key={logo.src}>
