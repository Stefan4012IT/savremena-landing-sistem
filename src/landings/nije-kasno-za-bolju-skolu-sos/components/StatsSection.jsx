...
function AnimatedStat({ stat, shouldAnimate }) {
  ...
  return (
    <article className="nije-kasno-za-bolju-skolu-sos-stats-section__item">
      <p className="nije-kasno-za-bolju-skolu-sos-stats-section__value">
        {stat.prefix}
        {displayValue}
        {stat.suffix}
      </p>
      <p className="nije-kasno-za-bolju-skolu-sos-stats-section__label">{stat.label}</p>
    </article>
  )
}
