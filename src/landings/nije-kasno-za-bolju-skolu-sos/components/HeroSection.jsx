    ...
    >
      ...
      <div className="nije-kasno-za-bolju-skolu-sos-hero__inner">
        <div className="nije-kasno-za-bolju-skolu-sos-hero__content" aria-label="Uvod u landing">
          <p className="nije-kasno-za-bolju-skolu-sos-hero__availability-intro">
            <span>Ostalo je</span> <strong>manje od</strong>
          </p>
          <picture className="nije-kasno-za-bolju-skolu-sos-hero__availability-count">
            <source media="(max-width: 760px)" srcSet={availableSeatsCopyMobile} />
            <img src={availableSeatsCopy} alt="10 slobodnih mesta" />
          </picture>
          <p className="nije-kasno-za-bolju-skolu-sos-hero__availability-outro">
            <span className="nije-kasno-za-bolju-skolu-sos-hero__availability-outro-desktop"><strong>za upis</strong> u generaciju</span>
            <span className="nije-kasno-za-bolju-skolu-sos-hero__availability-outro-mobile"><strong>za upis</strong> u</span>
            <span className="nije-kasno-za-bolju-skolu-sos-hero__availability-outro-mobile">generaciju</span>
            <span>2026/27!</span>
          </p>
        </div>
        ...
        <p className="nije-kasno-za-bolju-skolu-sos-hero__supporting-copy">
