...
export function TestimonialsSection() {
  ...
  return (
    <section className="nije-kasno-za-bolju-skolu-sos-landing-section nije-kasno-za-bolju-skolu-sos-testimonials-section">
      <div className="nije-kasno-za-bolju-skolu-sos-landing-container">
        <SectionHeader
          ...
          text={section.text}
        />
        <div className="nije-kasno-za-bolju-skolu-sos-testimonials-carousel" aria-label="Testimonijali">
          <div className="nije-kasno-za-bolju-skolu-sos-testimonials-carousel__track" ref={trackRef}>
            {testimonialCards.map((testimonial, index) => {
              ...
              return (
                <div
                  className="nije-kasno-za-bolju-skolu-sos-testimonials-carousel__slide"
          ...
          <div className="nije-kasno-za-bolju-skolu-sos-testimonials-carousel__dots" aria-label="Navigacija testimonijala">
            {testimonialCards.map((testimonial, index) => (
              <button
                className={index === activeIndex ? 'nije-kasno-za-bolju-skolu-sos-is-active' : ''}
                type="button"
                key={testimonial.title}
