...
export const testimonials = [
  ...
  {
    title: 'Futuristički pristup nastavi',
    text: 'Ovu školu od drugih škola izdvaja futuristički pristup nastavi i drugačiji odnos prema učenicima.',
    author: 'Tamara Polić',
