...
export const testimonials = [
  {
    title: 'Oduvek sam želela najbolje obrazovanje',
    text: 'Tokom četiri godine provedene u International Schoolu, shvatila sam da je Cambridge program savršen za mene. Škola ne samo da pruža fenomenalne akademske prilike kojima svaki učenik može da obogati svoj portfolio već je i mesto puno pozitivne energije za koju su zaslužni divni profesori.',
    author: 'Elena Ćuća',
    role: 'učenica International Schoola',
    initials: 'EĆ',
  ...
  {
    title: 'Lakši upis na fakultet u inostranstvu',
    text: 'International School ima program i pristup za decu poput mog deteta, koje je završilo osnovnu školu maltene u inostranstvu, a dva razreda u Srbiji, i nikada se nije uklopilo u taj način učenja. Razlog zašto smo izabrali ovaj Cambridge International program jeste to što će ona imati nastavu na engleskom jeziku, a to će joj omogućiti lakši upis na fakultet u inostranstvu.',
...
export const NijeKasnoZaBoljuSkoluIsLanding = {
  ...landingData,
