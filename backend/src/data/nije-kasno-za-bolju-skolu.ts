...
export const landingData = {
  ...
  gtmId: 'GTM-WRTKDP',
  seo: {
    title: 'Još nije kasno za bolju školu | Upis u Savremenu gimnaziju 2026/27',
    description:
