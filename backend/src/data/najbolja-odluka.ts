...
export const najboljaOdlukaLanding = {
  ...
  testimonialCards: [
    ...
    { title: 'Kao roditelj sam stvarno presrećna i zahvalna', text: '', author: 'Nataša Petković', role: 'roditelj', initials: 'NP', avatarImageUrl: placeholderImages.testimonialAvatars[1], videoImageUrl: placeholderImages.testimonialVideos[0], variant: 'video' },
    {
    ...
    { title: 'Futuristički pristup nastavi', text: 'Ovu školu od drugih škola izdvaja futuristički pristup nastavi i drugačiji odnos prema učenicima.', author: 'Tamara Polić', role: 'učenica Savremene gimnazije', initials: 'TP', avatarImageUrl: placeholderImages.testimonialAvatars[4], videoImageUrl: placeholderImages.testimonialVideos[1], variant: 'video' },
  ],
  footer: {
