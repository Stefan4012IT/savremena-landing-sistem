...
export const najboljaOdlukaLanding = {
  ...
  testimonialCards: [
    ...
    { title: 'Kao roditelj sam stvarno presrecna i zahvalna', text: '', author: 'Natasa Petkovic', role: 'roditelj', initials: 'NP', avatarImageUrl: placeholderImages.testimonialAvatars[1], videoImageUrl: placeholderImages.testimonialVideos[0], variant: 'video' },
    {
    ...
    { title: 'Futuristicki pristup nastavi', text: 'Ovu skolu od drugih skola izdvaja futuristicki pristup nastavi i drugaciji odnos prema ucenicima.', author: 'Tamara Polic', role: 'ucenica Savremene gimnazije', initials: 'TP', avatarImageUrl: placeholderImages.testimonialAvatars[4], videoImageUrl: placeholderImages.testimonialVideos[1], variant: 'video' },
  ],
  footer: {
